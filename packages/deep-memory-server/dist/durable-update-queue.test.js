...
describe("DurableUpdateQueue", () => {
    ...
    it("recovers inflight tasks on restart", async () => {
        ...
        await fs.writeFile(fakeFile, JSON.stringify({
            kind: "update",
            id: "x",
            key: "default::s2",
            namespace: "default",
    ...
    it("exports failed tasks without messages", async () => {
        ...
        await fs.writeFile(path.join(failedDir, "x.json"), JSON.stringify({
            kind: "update",
            id: "x",
            key: "default::s1",
            namespace: "default",
        ...
        if (out.mode === "list") {
            ...
            expect(out.items[0].messages).toBeUndefined();
    ...
    it("retries failed tasks by key with limit", async () => {
        ...
        const pendingDir = path.join(dir, "pending");
        const now = Date.now();
        await fs.writeFile(path.join(failedDir, "a.json"), JSON.stringify({
            kind: "update",
            id: "a",
            key: "default::s1",
            namespace: "default",
        ...
        await fs.writeFile(path.join(failedDir, "b.json"), JSON.stringify({
            kind: "update",
            id: "b",
            key: "default::s1",
            namespace: "default",
...
//# sourceMappingURL=durable-update-queue.test.js.map